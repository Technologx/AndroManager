...
package com.technologx.andromanager.services;
...
import com.technologx.andromanager.utils.DataPackage;
import com.technologx.andromanager.utils.Futils;
import com.technologx.andromanager.utils.GenericCopyThread;
...
public class ExtractService extends Service {
    ...
    public class DoWork extends AsyncTask<Bundle, Void, Integer> {
        ...
        private void unzipRAREntry(Archive zipFile, FileHeader entry, String outputDir)
            ...
            //	Log.i("AndroManager", "Extracting: " + entry);
            BufferedInputStream inputStream = new BufferedInputStream(
                    zipFile.getInputStream(entry));
            BufferedOutputStream outputStream = new BufferedOutputStream(
        ...
        public boolean extract(File archive, String destinationPath,
            ...
            try {
                ...
                Log.e("andromanger", "Error while extracting file " + archive, e);
        ...
        public boolean extractTar(File archive, String destinationPath) {
            ...
            try {
                ...
                Log.e("andromanager", "Error while extracting file " + archive, e);
                AppConfig.toast(getApplicationContext(), getString(R.string.error));
                return false;
            }
        ...
        protected Integer doInBackground(Bundle... p1) {
            ...
            if(entries!=null && entries.size()!=0) {
                ...
                extractTar(f, path);
            Log.i("andromanager", "Almost Completed");
     ...
     * data to be transferred to {@link com.technologx.andromanager.fragments.ProcessViewer}
     ...
     * is executing the callbacks in {@link com.technologx.andromanager.fragments.ProcessViewer}
     * @return
     */
