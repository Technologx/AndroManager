...
public class Constants {
     ...
     *  intent.setPackage("com.technologx.andromanager");
     *  intent.putExtra("com.technologx.andromanager.extra.TITLE", "Select the file...");
     *
     *  ... and then startActivityForResult
     * </code>
     *
     */
    public static final String FILE_PICKER_TITLE_BUNDLE_KEY = "com.technologx.andromanager.extra.TITLE";
