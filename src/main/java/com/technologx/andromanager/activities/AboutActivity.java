...
public class AboutActivity extends BasicActivity implements View.OnClickListener {
    ...
    private static final String URL_AUTHOR_1_G_PLUS = "https://plus.google.com/+KevinTechnologx";
    private static final String URL_AUTHOR_1_PAYPAL = "technologx@yahoo.com";
    private static final String URL_AUTHOR_2_G_PLUS = "";
    private static final String URL_AUTHOR_2_PAYPAL = "";
    private static final String URL_REPO_CHANGELOG = "https://github.com/Technologx/AndroidProjectsFiles/blob/master/updatenotes.md";
    private static final String URL_REPO_ISSUES = "https://technologx.com";
    private static final String URL_REPO_TRANSLATE = "https://translate.zanata.org/project/view/com.technologx.andromanager?dswid=4075";
    private static final String URL_REPO_G_PLUS_COMMUNITY = "https://plus.google.com/communities/109556580205855129702";
    private static final String URL_REPO_XDA = "";
    private static final String URL_REPO_RATE = "market://details?id=com.technologx.andromanager";
    private static final String TAG_CLIPBOARD_DONATE = "donate_id";
    private static final String URL_DONATE_2 = "https://paypal.me/technologx";
