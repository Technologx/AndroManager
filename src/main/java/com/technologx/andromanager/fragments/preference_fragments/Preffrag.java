...
package com.technologx.andromanager.fragments.preference_fragments;
...
import com.technologx.andromanager.BuildConfig;
import com.technologx.andromanager.R;
import com.technologx.andromanager.activities.AboutActivity;
import com.technologx.andromanager.activities.BaseActivity;
import com.technologx.andromanager.ui.views.CheckBx;
...
public class Preffrag extends PreferenceFragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference("colors").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                ((com.technologx.andromanager.activities.Preferences) getActivity()).selectItem(1);
                return true;
            }
        });
        ...
        preference3.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Feedback : AndroManager");
